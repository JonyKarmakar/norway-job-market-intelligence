...
>
> In this document, a raw source event means the source payload after required
> privacy minimisation, including removal of `contactList`, and before analytical
> transformation. Accepted decisions in `docs/decisions.md` and the source
> contract in `docs/data-source-notes.md` take precedence over older planning
> language in this detailed specification.
